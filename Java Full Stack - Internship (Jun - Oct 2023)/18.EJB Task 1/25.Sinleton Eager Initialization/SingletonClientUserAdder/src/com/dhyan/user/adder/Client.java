...
public class Client
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            remoteObj = (SingletonRemoteInterface) context.lookup("ejb:SingletonServer/SingletonServerEJB/SingletonImplementaion!com.dhyan.common.singleton.SingletonRemoteInterface");
            while (true)
            {
