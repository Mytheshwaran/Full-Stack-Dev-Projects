...
public class HTTPServer {
	public static void main(String[] args) {
		try {
			...
			//If Client search URL: http://localhost:8080/home/mytheshwaran/Documents/mytheshwaran.html in web browser 
			//This program will load the mytheshwaran.html file as response for the client
